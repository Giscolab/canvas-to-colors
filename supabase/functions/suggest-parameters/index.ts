...
const SETTINGS_SCHEMA = {
  ...
  properties: {
    ...
    paintEffect: { type: "string", enum: ["none", "watercolor", "brush", "pointillism", "impasto"] },
    paintIntensity: { type: "integer", description: "Entre 0 et 100" },
    artisticEffect: { type: "string", enum: ["none", "oil", "pencil", "ink", "pastel"] },
  ...
  try {
    ...
    const suggestion = {
      ...
      settings: {
        ...
        paintEffect: asEnum(parsed.paintEffect, ["none", "watercolor", "brush", "pointillism", "impasto"] as const, "none"),
        paintIntensity: clampInt(parsed.paintIntensity, 0, 100, 0),
        artisticEffect: asEnum(parsed.artisticEffect, ["none", "oil", "pencil", "ink", "pastel"] as const, "none"),
